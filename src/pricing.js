// Pricing Abona - Source unique de vérité pour le calcul des prix.
// Toute modification ici DOIT être répliquée dans functions/pricing.js
// Les deux fichiers ont un contenu identique (ES modules vs CommonJS).

import { DISCOUNT_RATE, DAYS_IN_MONTH, MAX_DURATION_DAYS, MIN_DURATION_DAYS } from './constants';
 ...
 */
export function calculatePrice(originalMonthlyPrice, durationDays) {
 ...
 */
export function calculateDiscountedMonthly(originalMonthlyPrice) {

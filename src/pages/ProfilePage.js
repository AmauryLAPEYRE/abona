        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-2">
            <div className="glass-card overflow-hidden">
              <div className="section-header bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
                <h2 className="text-xl font-bold text-white">Informations personnelles</h2>
              </div>

              <div className="p-6">
                {error && (
                  <div className="glass-alert-error border-l-4 border-red-500 p-4 mb-6" role="alert">
                    <p>{error}</p>
                  </div>
                )}

                {success && (
                  <div className="glass-alert-success border-l-4 border-green-500 p-4 mb-6" role="alert">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        id="name"
                        className="glass-input block w-full sm:text-sm rounded-md"
                        value={name}
                    ...
                    <div>
                      <button
                        type="submit"
                        disabled={loading}
                        className="btn-primary inline-flex items-center px-4 py-2 text-sm font-medium rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {loading ? (
                          <>
              ...
              <div className="p-6">
                {loadingHistory ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-white/50">Aucun historique de paiement</p>
                  </div>
                ) : (
                          ...
                          <tr key={payment.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                ${payment.status === 'succeeded' ? 'badge-active' :
          ...
          <div className="col-span-1">
            <div className="glass-card overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <Link
                    to="/password-reset"
                    className="flex items-center px-4 py-3 text-sm text-white/80 rounded-lg hover:bg-white/10 transition-colors"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-white/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="border-t border-white/10 pt-4 mt-4">
                    <p className="text-xs text-white/50 mb-2">Membre depuis :</p>
            ...
            <div className="glass-card overflow-hidden mt-8">
              <div className="p-6">
                <h3 className="text-lg font-medium text-white mb-4">Actions de compte</h3>

                <div className="space-y-3">
                  <Link
                    to="/dashboard"
                    className="flex justify-between items-center px-4 py-3 text-sm text-white/80 rounded-lg hover:bg-white/10 transition-colors"
                  >
                  ...
                  <button
                    className="w-full flex justify-between items-center px-4 py-3 text-sm text-red-400 rounded-lg hover:bg-red-500/10 transition-colors"
                  >
                    <div className="flex items-center">

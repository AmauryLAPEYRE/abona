...
const LandingPage = () => {
  ...
  if (loading && popularServices.length === 0) {
    return (
      <div className="page-bg text-white py-12">
  ...
  return (
    <div className="page-bg text-white">
          ...
          <div className="flex space-x-4 items-center">
            {currentUser ? (
              <div className="relative group">
                ...
                {/* Menu déroulant */}
                <div className="glass-dropdown hidden group-hover:block">
                  <Link to="/profile" className="glass-dropdown-item">
                    Mon profil
                  </Link>
                  <Link to="/dashboard" className="glass-dropdown-item">
                    Mes abonnements
                  </Link>
                  <button
      ...
      <div className="container mx-auto px-4 pt-16 pb-24">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500"> au juste prix</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto">
            Ne payez que ce que vous consommez. Accédez aux meilleurs services à <span className="font-bold text-white">-{DISCOUNT_RATE * 100}%</span>, de {MIN_DURATION_DAYS} à {MAX_DURATION_DAYS} jours. Sans engagement, sans gaspillage.
          </p>
      ...
      {/* Comment ça marche */}
      <div className="glass-card rounded-none py-20">
        <div className="container mx-auto px-4">
            ...
            {popularServices.length > 0 ? (
              popularServices.map((service) => {
                ...
                return (
                  <div
                    key={service.id}
                    className="glass-card overflow-hidden hover:shadow-glow-blue transition-all duration-300"
                  >
                    <div
                    ...
                    <div className="p-6">
                      ...
                      <Link to={`/service/${service.id}`} className="btn-primary mt-4 w-full">
                        Voir l'offre
                      </Link>
                    </div>
                  </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-700 to-purple-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="glass-card p-4 ring-2 ring-green-400">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-center">
            ...
            {currentUser ? (
              <Link
                to="/dashboard"
                className="inline-flex items-center justify-center bg-white text-blue-600 hover:bg-gray-100 transition-all duration-200 px-8 py-4 rounded-lg font-bold text-lg"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-400">Vos services premium, au juste prix</p>
            </div>

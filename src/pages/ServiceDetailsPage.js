  ...
  return (
    <div className="page-bg text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <Link to="/services" className="text-blue-400 hover:text-blue-300 font-medium inline-flex items-center mb-6">
        ...
        <div className="glass-card overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-8">
              ...
              {service.category && (
                <div className="mb-4">
                  <span className="px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full bg-blue-500/20 text-blue-300">
                    {service.category}
                  </span>
                </div>
              )}
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold text-white mb-4">Choisissez votre abonnement</h2>
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <p className="text-sm text-white/40 line-through">{subscription.price.toFixed(2)} €</p>
                      <p className="text-lg font-bold text-green-400">{calculateDiscountedMonthly(subscription.price).toFixed(2)} €</p>
                      <p className="text-xs text-green-400 font-semibold">-{DISCOUNT_RATE * 100}% / mois</p>
                    </div>
                  </div>
        ...
        {selectedSubscription && (
          <div className="glass-card overflow-hidden mt-8">
            ...
            <div className="p-6">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-white mb-4">Abonnement sélectionné</h3>

                <div className="bg-white/5 rounded-lg p-4 flex justify-between items-center mb-6">
                  <div>
                    <p className="font-medium text-white">{selectedSubscription.name}</p>
                  ...
                  <div className="text-right">
                    <p className="text-sm text-white/40 line-through">{selectedSubscription.price.toFixed(2)} €/mois</p>
                    <p className="text-xl font-bold text-green-400">{calculateDiscountedMonthly(selectedSubscription.price).toFixed(2)} €/mois</p>
                    <p className="text-xs text-green-400 font-semibold">-{DISCOUNT_RATE * 100}% avec Abona</p>
                  </div>
                </div>

                <h3 className="text-md font-bold text-white mb-4">Choisissez votre type d'abonnement</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="recurring" className="ml-2 block text-sm font-medium text-white/80">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                    />
                    <label htmlFor="one-time" className="ml-2 block text-sm font-medium text-white/80">
                      Durée unique
                    </label>
                  </div>
                  ...
                  {!isRecurring && (
                    <div className="mt-2 pl-6">
                      <label htmlFor="custom-duration" className="block text-sm font-medium text-white/80 mb-2">
                      ...
                      <div className="flex items-center">
                        ...
                        />
                        <span className="text-sm font-medium w-16 text-center text-white">{customDuration} jours</span>
                      </div>
                    </div>
                  )}

                  {/* Affichage du prix */}
                  <div className="glass-card p-3 bg-green-500/10 border border-green-500/20 mt-4">
                    {isRecurring ? (
                      <div className="flex justify-between">
                        <span className="text-white/70">Abonnement mensuel:</span>
                      ...
                      <>
                        <div className="flex justify-between">
                          <span className="text-white/70">Prix officiel:</span>
                          <span className="text-white/40 line-through">{selectedSubscription.price.toFixed(2)} €/mois</span>
                        </div>
                        <div className="flex justify-between mt-1">
                          <span className="text-white/70">Prix Abona (-{DISCOUNT_RATE * 100}%):</span>
                          <span className="font-medium text-green-400">{calculateDiscountedMonthly(selectedSubscription.price).toFixed(2)} €/mois</span>
                        </div>
                        <div className="flex justify-between mt-1 pt-2 border-t border-green-500/20">
                          <span className="text-white font-medium">Total pour {customDuration} jours:</span>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-medium text-white">Accès sécurisé</h3>
            </div>
          ...
          <div className="glass-card p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-medium text-white">Support 24/7</h3>
            </div>
            <p className="text-white/60">
          ...
          <div className="glass-card p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-medium text-white">Durée flexible</h3>
            </div>
            <p className="text-white/60">
